...
public class DlgLine extends JDialog {
	...
	public DlgLine() {
		...
		}
		{
			...
			lblStartPointCoordinates.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 22));
		...
		}
		{
			...
			lblXCoordinate.setForeground(Color.DARK_GRAY);
		...
		}
		{
			...
			lblYCoordinate.setForeground(Color.DARK_GRAY);
		...
		}
		{
			...
			lblEndPointCoordinates.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 22));
		...
		}
		{
			...
			lblYKoordinata_1.setForeground(Color.DARK_GRAY);
